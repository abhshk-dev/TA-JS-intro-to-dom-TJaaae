...
allHrsArray.forEach(elm=> elm.style.border='1px solid black');
...
let classHr=document.querySelectorAll('.image');
let classHrArray=Array.from(classHr);
classHrArray.forEach(elm=>elm.style.border='2px solid purple');
// Hide the box number 17 (last box).

// Change the border of all the hr element from solid to dashed type
allHrsArray.forEach(elm=> elm.style.border='1px dashed black');
